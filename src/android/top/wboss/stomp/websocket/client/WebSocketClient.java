package top.wboss.stomp.websocket.client;
...
import top.wboss.stomp.websocket.WebSocket;
...
public abstract class WebSocketClient extends WebSocketAdapter implements Runnable, WebSocket {
	...
	public WebSocketClient(URI serverUri, Map<String, String> header) {
		this( serverUri, new Draft_17(), header, 0 );
	}
